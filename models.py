...
class Sentiment_rating(db.Model):
    ...
    #track_duration = db.Column(db.Integer, nullable=True, index=True)    
    happy_rating = db.Column(db.Integer, nullable=True, index=True)
    sadness_rating = db.Column(db.Integer, nullable=True, index=True)       
    annoying_rating = db.Column(db.Integer, nullable=True, index=True)
    anxious_rating = db.Column(db.Integer, nullable=True, index=True)
    energizing_rating = db.Column(db.Integer, nullable=True, index=True)    
    neutral_rating = db.Column(db.Integer, nullable=True, index=True)
    dreamy_rating = db.Column(db.Integer, nullable=True, index=True)
    relaxing_rating = db.Column(db.Integer, nullable=True, index=True)
